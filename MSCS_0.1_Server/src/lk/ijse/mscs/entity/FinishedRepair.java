...
public class FinishedRepair {
    ...
    public FinishedRepair(String customerId, String description, double unitPrice, String customerName, String itemId, String acceptedDate, String contactNo, String defects, String replaceAccessories) {
    ...
    public FinishedRepair(String finished_O_Id, String customerId, String description, double unitPrice, String customerName, String itemId, String acceptedDate, String contactNo, String defects, String replaceAccessories) {
    ...
    public String toString() {
        return "FinishedRepair{" + "finished_O_Id=" + finished_O_Id + ", customerId=" + customerId + ", description=" + description + ", unitPrice=" + unitPrice + ", customerName=" + customerName + ", itemId=" + itemId + ", acceptedDate=" + acceptedDate + ", contactNo=" + contactNo + ", defects=" + defects + ", replaceAccessories=" + replaceAccessories + '}';
    }
