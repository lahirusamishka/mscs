...
public class GRN {
    ...
    public GRN(String batchId, String sOrderId, String itemBrand, String description, String orderQty, String orderDate, String SupplierId, String deliverdDate, String deliverdQty, String warranty, double unitPrice, String sallingPrice) {
    ...
    public GRN(String grnId, String batchId, String sOrderId, String itemBrand, String description, String orderQty, String orderDate, String SupplierId, String deliverdDate, String deliverdQty, String warranty, double unitPrice, String sallingPrice) {
        this.grnId = grnId;
        this.batchId = batchId;
        this.sOrderId = sOrderId;
        this.itemBrand = itemBrand;
    ...
    public String toString() {
        return "GRN{" + "grnId=" + grnId + ", batchId=" + batchId + ", sOrderId=" + sOrderId + ", itemBrand=" + itemBrand + ", description=" + description + ", orderQty=" + orderQty + ", orderDate=" + orderDate + ", SupplierId=" + SupplierId + ", deliverdDate=" + deliverdDate + ", deliverdQty=" + deliverdQty + ", warranty=" + warranty + ", unitPrice=" + unitPrice + ", sallingPrice=" + sallingPrice + '}';
    }
