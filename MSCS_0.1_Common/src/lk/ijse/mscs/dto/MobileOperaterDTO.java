 ...
 * @author samishka
 */
public class MobileOperaterDTO extends SuperDTO{
    ...
    public MobileOperaterDTO() {
    }

    public MobileOperaterDTO(String NIC, String name, String address, String Contact, String Email) {
        this.NIC = NIC;
        this.name = name;
    ...
    public MobileOperaterDTO(String MobileOperaterId, String NIC, String name, String address, String Contact, String Email) {
