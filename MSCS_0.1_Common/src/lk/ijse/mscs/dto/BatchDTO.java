...
public class BatchDTO extends SuperDTO {
    ...
    public BatchDTO(String SupplierOrderId, String SupplierOrderDate, String GRNID, String GRNDate) {
    ...
    public BatchDTO(String bachId, String SupplierOrderId, String SupplierOrderDate, String GRNID, String GRNDate) {
        this.bachId = bachId;
        this.SupplierOrderId = SupplierOrderId;
        this.SupplierOrderDate = SupplierOrderDate;
        this.GRNID = GRNID;
    ...
    public String toString() {
        return "BatchDTO{" + "bachId=" + bachId + ", SupplierOrderId=" + SupplierOrderId + ", SupplierOrderDate=" + SupplierOrderDate + ", GRNID=" + GRNID + ", GRNDate=" + GRNDate + '}';
    }
